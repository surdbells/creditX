  ...
  sections: [
    // ─── COVER PAGE ───
    {
      ...
      children: [
        ...
        boldPara("Default admin: ", "admin@dostsuite.com / Admin@123456"),
        sectionBreak(),
        ...
        codePara("Domain: api.dostsuite.com"),
        ...
        codePara("server {"),
        codePara("    listen 80;"),
        codePara("    server_name api.dostsuite.com;"),
        ...
        codePara("curl -s http://api.dostsuite.com/api/health | jq ."),
        ...
        bulletItem("Environment variables: Set API_URL = https://api.dostsuite.com/api"),
        bulletItem("Custom domain: admin.dostsuite.com"),
        ...
        codePara("  apiUrl: 'https://api.dostsuite.com/api',"),
        codePara("};"),
        sectionBreak(),
        ...
        bulletItem("aaPanel → Website → SSL → Apply Let's Encrypt certificate for api.dostsuite.com"),
        ...
        bulletItem("Review and lock CORS origins in .env (CORS_ORIGIN=https://admin.dostsuite.com)"),
        ...
        makeTable(
          ...
          [
            ...
            ["Nginx access", "/www/wwwlogs/api.dostsuite.com.log", "HTTP request log"],
            ["Nginx errors", "/www/wwwlogs/api.dostsuite.com.error.log", "Nginx errors"],
        ...
        bulletItem("Verify health: curl https://api.dostsuite.com/api/health"),
        ...
        makeTable(
          ...
          [
            ...
            ["CORS_ORIGIN", "https://admin.dostsuite.com", "Yes", "Allowed CORS origin"],
            ["STORAGE_PATH", "storage/uploads", "Yes", "File storage path"],
            ["ZEPTOMAIL_API_KEY", "***", "No", "ZeptoMail API key for email"],
            ["ZEPTOMAIL_FROM_EMAIL", "noreply@dostsuite.com", "No", "From email address"],
            ...
            ["FRONTEND_URL", "https://admin.dostsuite.com", "Yes", "Admin frontend URL"],
          ]
        ),
        para(""),
