...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'credit-bureau', loadComponent: () => import('./features/credit-bureau/credit-bureau.component').then(m => m.CreditBureauComponent) },
      ...
      { path: 'investment-products', loadComponent: () => import('./features/investment-products/investment-products.component').then(m => m.InvestmentProductsComponent) },
      { path: 'investments', loadComponent: () => import('./features/investments/investments.component').then(m => m.InvestmentsComponent) },
      { path: 'investment-accrual', loadComponent: () => import('./features/investment-accrual/investment-accrual.component').then(m => m.InvestmentAccrualComponent) },
      ...
      { path: 'accounting-period', loadComponent: () => import('./features/accounting-period/accounting-period.component').then(m => m.AccountingPeriodComponent) },
