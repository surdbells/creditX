  ...
  template: `
    <div class="cx-animate-in">
      <cx-page-header title="Departments" subtitle="Manage organizational departments">
        <button class="cx-btn cx-btn-primary" (click)="openForm()"><lucide-icon name="plus" [size]="16"></lucide-icon> Add Department</button>
      </cx-page-header>
    ...
    <cx-form-dialog [open]="showForm()" [title]="editId ? 'Edit Department' : 'Create Department'" [saving]="saving()" (close)="showForm.set(false)" (save)="saveForm()">
      <div class="space-y-4">
