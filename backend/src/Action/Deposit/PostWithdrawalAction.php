...
/**
 * POST /api/deposits/accounts/{id}/withdraw — withdraw money from an account.
 * The product's withdrawal policy is enforced by the service.
 * Gated by deposits.transact.
 */
final class PostWithdrawalAction
{
    use ApiResponse;
    ...
    public function __invoke(ServerRequestInterface $request, ResponseInterface $response, array $args): ResponseInterface
    {
        ...
        try {
            $txn = $this->service->withdraw($account, $amount, $postingDate, $reference ?: null, $userId);
        ...
        return $this->created($txn->toArray(), 'Withdrawal posted successfully');
    }
}
