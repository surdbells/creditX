...
$permissionsDef = [
    ...
    'reports' => [['reports.portfolio','Portfolio Reports'],['reports.par','PAR Reports'],['reports.performance.agents','Agent Performance Report'],['reports.performance.branches','Branch Performance Report'],['reports.performance.products','Product Performance Report'],['reports.performance.approvers','Approver Performance Report'],['reports.cbn','CBN Reports'],['reports.reconciliation','Reconciliation'],['reports.export','Export Reports']],
...
$rolesDef = [
    ...
    ['Operations Head', 'operations_head', 'Head of operations', true, ['loans.view','loans.approve','loans.reject','loans.disburse','loans.close','loans.write_off','loans.restructure','customers.view','records.view','products.view','accounting.view','payments.view','reports.portfolio','reports.par','reports.performance.agents','reports.performance.branches','reports.performance.products','reports.performance.approvers','reports.cbn','reports.export','messaging.view','messaging.send','maker_checker.check','notifications.view']],
