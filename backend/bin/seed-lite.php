...
$permissionsDef = [
    ...
    'accounting' => [['accounting.view','View Accounting'],['accounting.create','Create GL Accounts'],['accounting.edit','Edit GL Accounts'],['accounting.journal','Post Journal Entries'],['accounting.reverse','Reverse Journal Entries'],['accounting.close','Close/Reopen Periods'],['accounting.budget','Manage Budgets']],
    'payments' => [['payments.view','View Payments'],['payments.create','Post Payments'],['payments.bulk_upload','Bulk Upload Payments']],
    'reports' => [['reports.portfolio','Portfolio Reports'],['reports.par','PAR Reports'],['reports.performance','Performance Reports'],['reports.cbn','CBN Reports'],['reports.reconciliation','Reconciliation'],['reports.export','Export Reports']],
...
$rolesDef = [
    ...
    ['Operations Head', 'operations_head', 'Head of operations', true, ['loans.view','loans.approve','loans.reject','loans.disburse','loans.close','loans.write_off','loans.restructure','customers.view','records.view','products.view','accounting.view','payments.view','reports.portfolio','reports.par','reports.performance','reports.cbn','reports.export','messaging.view','messaging.send','maker_checker.check','notifications.view']],
    ...
    ['Accountant', 'accountant', 'Financial operations', true, ['accounting.view','accounting.create','accounting.edit','accounting.journal','accounting.reverse','accounting.close','accounting.budget','payments.view','payments.create','reports.portfolio','reports.par','reports.reconciliation','reports.cbn','reports.export','notifications.view']],
